...
public class ConfInterpreterTest extends AbstractInterpreterTest {
  ...
  public void testCorrectConf() throws IOException, InterpreterException {
    ...
    assertTrue(interpreterFactory.getInterpreter("user1", "note1", "test.conf")
            instanceof ConfInterpreter);
    ConfInterpreter confInterpreter = (ConfInterpreter) interpreterFactory.getInterpreter("user1",
            "note1", "test.conf");
